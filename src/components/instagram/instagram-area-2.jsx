...
const instagram_data = [
  { id: 1, link: "https://www.instagram.com/ritah_katana_beauty_centre/", img: insta_1 },
  { id: 2, link: "https://www.instagram.com/ritah_katana_beauty_centre/", img: insta_2 },
  { id: 3, link: "https://www.instagram.com/ritah_katana_beauty_centre/", banner: true, img: insta_icon },
  { id: 4, link: "https://www.instagram.com/ritah_katana_beauty_centre/", img: insta_3 },
  { id: 5, link: "https://www.instagram.com/ritah_katana_beauty_centre/", img: insta_4 },
];
              ...
              item.banner ? (
                ...
                <div key={item.id} className="col">
                  <div className="tp-instagram-item-2">
                    <Image unoptimized={true} src={item.img} alt="user image" style={{width:'100%',height:'100%'}} />
