...
// internal
// The image has been placed in public/assets
const special_thumb = '/assets/img/product/special/big/before_after.jpeg';
            ...
            <div className="col-xl-5 col-md-6">
              <div className="tp-special-slider-thumb">
                <div className="tp-special-thumb">
                  <Image unoptimized={true} src={special_thumb} alt="Katana Skincare Before and After" width={600} height={600} style={{ width: '100%', height: 'auto', borderRadius: '16px' }} />
                  <div className="tp-special-hotspot-item tp-special-hotspot-1">
                    ...
                    <div className="tp-special-hotspot-content">
                      <h3 className="tp-special-hotspot-title">
                        <Link href="/shop?category=beauty-products">Acne Clearing Combo</Link>
                      </h3>
                      <p>Clear spots and hyperpigmentation.</p>
                    </div>
                  </div>
                  <div className="tp-special-hotspot-item tp-special-hotspot-2">
                    ...
                    <div className="tp-special-hotspot-content">
                      <h3 className="tp-special-hotspot-title">
                        <Link href="/shop?category=beauty-products">Glass Skin Oil</Link>
                      </h3>
                      <p>Achieve flawless glowing skin.</p>
                    </div>
                  </div>
