    ...
    <div className="tp-checkout-place white-bg">
      ...
      <div className="tp-checkout-payment">
        <div className="tp-checkout-payment-item">
          ...
          <div className="direct-bank-transfer mt-10">
            <p className="mb-0" style={{fontSize: '14px', lineHeight: '1.5', color: '#55585B'}}>
              <strong>Account number:</strong> 1042100504382<br/>
              <strong>Account name:</strong> Nabayaza Sara<br/>
              <strong>Bank:</strong> Equity bank uganda
            </p>
          </div>
