            ...
            <div className="row">
              ...
              <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                <div className="tp-footer-widget footer-col-2 mb-50">
                  ...
                  <div className="tp-footer-widget-content">
                    <ul>
                      <li><Link href="/shop?category=packages">Packages</Link></li>
                      <li><Link href="/shop?category=weight-loss">Weight Loss</Link></li>
                      <li><Link href="/shop?category=beauty-products">Beauty Products</Link></li>
                      <li><Link href="/shop?category=bedroom-products">Bedroom Products</Link></li>
                      <li><Link href="/shop?category=good-luck-miracle-products">Good Luck Miracle Products</Link></li>
                      <li><Link href="/shop?category=hips-and-bums-enlargements">Hips and Bums Enlargements</Link></li>
                    </ul>
                  </div>
                </div>
              </div>
                ...
                <div className="tp-footer-widget footer-col-4 mb-50">
                  ...
                  <div className="tp-footer-widget-content">
                    <div className="tp-footer-talk mb-20">
                      ...
                      <h4><a href="tel:+256782682878">+256 782 682878</a></h4>
                    </div>
                    <div className="tp-footer-contact">
                      <div className="tp-footer-contact-item d-flex align-items-start">
                        ...
                        <div className="tp-footer-contact-content">
                          <p><a href="mailto:Katanaritah256@gmail.com">Katanaritah256@gmail.com</a></p>
                        </div>
                      </div>
                      <div className="tp-footer-contact-item d-flex align-items-start">
                        <div className="tp-footer-contact-icon">
                        ...
                        <div className="tp-footer-contact-content">
                          <p><a href="https://www.google.com/maps/search/Rm+F9,+Annet+Plaza,+Opp.+Old+Taxi+Park,+Kampala,+Uganda" target="_blank">Rm F9, Annet Plaza, <br /> Opp. Old Taxi Park, Kampala, Uganda</a></p>
                        </div>
                      </div>
                    </div>
                  </div>
